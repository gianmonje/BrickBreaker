...
public class WallPositionController : MonoBehaviour {
    ...
    void Start() {
        ...
        bottomCollider.gameObject.AddComponent<DeathWall>();
        ...
        bottomCollider.position = new Vector3(cameraPos.x, (cameraPos.y - screenSize.y - (bottomCollider.localScale.y * 0.5f)) + deathWallYOffset, zPosition);
    }
